...
const handler = async (m, {command, conn}) => {
  ...
  if (command == 'nsfwloli') {
    ...
    conn.sendMessage(m.chat, {image: {url: haha}, caption: `> Resultados para: *${command}*`.trim()}, {quoted: m});
  }
  ...
  if (command == 'tetas') {
    ...
    conn.sendMessage(m.chat, {image: {url: res}, caption: `> Resultados para: *${command}*`.trim()}, {quoted: m});
  }
  ...
  if (command == 'ecchi') {
    ...
    conn.sendMessage(m.chat, {image: {url: url}, caption: `> Resultados para: *${command}*`.trim()}, {quoted: m});
  }
