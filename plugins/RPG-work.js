const handler = async (m, {conn, isPrems}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 60000) throw `⧼✦⧽ 𝔼𝕤𝕡𝕖𝕣𝕒 *${msToTime(time - new Date())}* 𝕡𝕒𝕣𝕒 𝕧𝕠𝕝𝕧𝕖𝕣 𝕒 𝕥𝕣𝕒𝕓𝕒𝕛𝕒𝕣.`;

  conn.sendMessage(m.chat, {text: `⧼✿⧽ 𝕋𝕖 𝕖𝕞𝕓𝕒𝕣𝕔𝕒𝕤 𝕖𝕟 𝕦𝕟𝕒 𝕖𝕞𝕠𝕔𝕚𝕠𝕟𝕒𝕟𝕥𝕖 𝕒𝕧𝕖𝕟𝕥𝕦𝕣𝕒:\n*→ ${pickRandom(global.work)}*\n◈ 𝔾𝕣𝕒𝕔𝕚𝕒𝕤 𝕒 𝕥𝕦 𝕒𝕧𝕖𝕟𝕥𝕦𝕣𝕒 𝕠𝕓𝕥𝕚𝕖𝕟𝕖𝕤 *${hasil}* 𝕕𝕖 𝕖𝕩𝕡𝕖𝕣𝕚𝕖𝕟𝕔𝕚𝕒.`}, {quoted: m});
...
global.work = [
  ...
  'Secuestraste a la creadora de Nekos Club y Aiden pagó por el rescate.'
  ];
