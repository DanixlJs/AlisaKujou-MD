...
${isWin ? `❀ @${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} ganaste *${winScore}* experiencia.` : isTie ? '✧ El juego terminó en un empate.' : `❀ Turno de @${room.game.currentTurn.split('@')[0]}`}`.trim();
