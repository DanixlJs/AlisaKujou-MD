...
async function handler(m, { conn: stars, usedPrefix }) {
  ...
  await stars.sendMessage(m.chat, { image: { url: "https://telegra.ph/file/b867188ad3e6ea1f593ad.png" }, caption: responseMessage, mentions: stars.parseMentions(responseMessage), quoted: m})
