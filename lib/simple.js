...
const {
  ...
  import ('@whiskeysockets/baileys')).default
  ...
  let sock = Object.defineProperties(conn, {
        ...
        logger: {
          get() {
            return {
              info(...args) {
                console.log(chalk.bold.bgRgb(51, 204, 51)('INFORMACION '), `[${chalk.rgb(255, 255, 255)(new Date().toUTCString())}]:`, chalk.cyan(format(...args)))
              },
              error(...args) {
                console.log(chalk.bold.bgRgb(247, 38, 33)('ERROR '), `[${chalk.rgb(255, 255, 255)(new Date().toUTCString())}]:`, chalk.rgb(255, 38, 0)(format(...args)))
              },
              warn(...args) {
                console.log(chalk.bold.bgRgb(255, 153, 0)('ADVERTENCIA '), `[${chalk.rgb(255, 255, 255)(new Date().toUTCString())}]:`, chalk.redBright(format(...args)))
              },
              trace(...args) {
