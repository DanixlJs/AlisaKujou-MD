...
export default async function (m, conn = { user: {} }) {
    ...
    let chatName = chat ? (m.isGroup ? `${chalk.magenta('Grupo ⪼')} ${chalk.green.bold(chat)}` : `${chalk.magenta('Chat Privado ⪼')} ${chalk.green.bold(chat)}) : '~Undefined';
...
│ 
│${chalk.magenta('◈ Usuario ⪼')} ${sender}
│${chalk.magenta('◈')} ${chatName}
╰───────────────────╼
